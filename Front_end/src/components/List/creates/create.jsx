...
export const Create = () => {
  ...
  const currentUsers = songs.slice(indexOfFirstUser, indexOfLastUser);


  const totalPages = Math.ceil(songs.length / usersPerPage);
  ...
  return (
      <div>
        ...
        <a className="item active button" onClick={() => {
          setShow(true);
        }} >
          Thêm mới
        </a>
